...
MW_API bool  Engine_initDriver(E_DRIVER_TYPE driverType, uint32_t adapter, bool fullscreen, bool vsync, uint32_t antialias, bool multithread);
...
MW_API WowClassic::wowDatabase*  Engine_getWowDatabase();
...
MW_API void Engine_getBaseDirectory(char* dirname, uint32_t size);
