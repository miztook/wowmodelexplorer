...
{
    /// <summary>
    /// Interaction logic for M2ItemSelect.xaml
    /// </summary>
    public partial class M2ItemSelect : UserControl
    {
        ...
        public M2ItemCollection Items
        {
            get { return _mainGrid.Resources["_items"] as M2ItemCollection; }
        }
        ...
        bool modelAscending = true;
        bool textureAscending = true;
        private void GridViewColumnHeader_Click(object sender, RoutedEventArgs e)
        {
            ...
            switch (header.Tag.ToString())
            {
                ...
                case "ModelPath":
                    {
                        itemsView.SortDescriptions.Add(new SortDescription("ModelPath",
                                               modelAscending ? ListSortDirection.Ascending : ListSortDirection.Descending));
                        modelAscending = !modelAscending;
                    }
                    break;
                case "TexturePath":
                    {
                        itemsView.SortDescriptions.Add(new SortDescription("TexturePath",
                                               textureAscending ? ListSortDirection.Ascending : ListSortDirection.Descending));
