...
//         public static decimal Sqr(decimal a) { return a * a; }
        ...
        public static float FACos(float angle) { return (float)Math.Acos(angle); }
        public static float FASin(float angle) { return (float)Math.Asin(angle); }
        public static float FATan(float angle) { return (float)Math.Atan(angle); }
        public static float FATan2(float y, float x) { return (float)Math.Atan2(y,x);  }
