...
DllImport typedef struct _ASTCOptions
{
    ...
    //DllImport _ASTCOptions();
    //DllImport _ASTCOptions(_ASTCOptions *);
    //DllImport bool isEqual(_ASTCOptions *);

    //DllImport _ASTCOptions & operator=(const _ASTCOptions &rhs);
    //DllImport _ASTCOptions & operator==(const _ASTCOptions &rhs);
...
{
    //DllImport _StandardOptions(int,int,void*);
    //DllImport _StandardOptions(_StandardOptions *);

    //DllImport _StandardOptions & operator=(const _StandardOptions &rhs);
    //DllImport _StandardOptions & operator==(const _StandardOptions *rhs);
...
/** class ASTCCompressionOptions
 *
 *  Class to contain the ASTC options. The ASTC Options window should
 *  have one of these and pass a copy back to the ASTC Compression Algorithm. 
 */
//class DllImport ASTCCompressionOptions
//{
//public:
//    ASTCCompressionOptions();
//    ASTCCompressionOptions(ASTCCompressionOptions *);
//
//public:
//    bool  isEqual(ASTCCompressionOptions *);
...
//    int   GetyDimension();
//
//    void  SetCompressionSpeed(int);
//    void  SetCompressionMode(int);
//    void  SetUseBitRate(bool);
//    void  SetBitRate(float);
//    void  SetxDimension(int);
//    void  SetyDimension(int);
//
//    bool  GetUseBuiltInOptimizations();
//    bool  GetApplyPSNROptimization();
//    bool  GetApplyPerceptualOptimization();
//    bool  GetApplyMaskOptimization();
//    bool  GetApplyAlphaOptimization();
//    bool  GetApplyHDROptimization();
//    bool  GetApplyHDRWithAlphaChannelOptimization();
//    bool  GetApplyHDRForLogErrorOptimization();
//    bool  GetApplyHDRWithAlphaChannelForLogErrorOptimization();
//
//    void  SetUseBuiltInOptimizations(bool);
//    void  SetApplyPSNROptimization(bool);
//    void  SetApplyPerceptualOptimization(bool);
//    void  SetApplyMaskOptimization(bool);
//    void  SetApplyAlphaOptimization(bool);
//    void  SetApplyHDROptimization(bool);
//    void  SetApplyHDRWithAlphaChannelOptimization(bool);
//    void  SetApplyHDRForLogErrorOptimization(bool);
//    void  SetApplyHDRWithAlphaChannelForLogErrorOptimization(bool);
//
//protected:
//    int     CompressionSpeed;
//    int     CompressionMode;
...
//    int     yDimension;
//
//    bool    UseBuiltInOptimizations;
//    bool    ApplyPSNROptimization;
//    bool    ApplyPerceptualOptimization;
//    bool    ApplyMaskOptimization;
//    bool    ApplyAlphaOptimization;
//    bool    ApplyHDROptimization;
//    bool    ApplyHDRWithAlphaChannelOptimization;
//    bool    ApplyHDRForLogErrorOptimization;
//    bool    ApplyHDRWithAlphaChannelForLogErrorOptimization;
//
//    //Extra variables used by the ASTC algorithm. 
//public:
//    int BitFidelity;
//    int ASTCCompressionMode;
//    unsigned char* astc_pData;
...
//
//};
////end ASTCCompressionOptions
//
//
///** class StandardCompressionOptions
// *
// *  All the compression types should use this for their options.
// *  It provides a standard way for the rest of QCompress to deal
// *  with options pointers until the exact compression type is known.
// */
//class DllImport StandardCompressionOptions
//{
//public:
//    StandardCompressionOptions(int,int,void*);
//    StandardCompressionOptions(StandardCompressionOptions *);
//
//    void    SetCompressionOptions(void *);
...
//    void *  CompressionOptions; //The pointer to the compression Options.
//};
//end StandardCompressionOptions
