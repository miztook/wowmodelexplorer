...
#define FBXSDK_VERSION_MAJOR	2015		//<! Integer, version major number
...
#define FBXSDK_VERSION_YEAR     2014		//<! Integer, release date year
#define FBXSDK_VERSION_MONTH	04			//<! Integer, release date month
#define FBXSDK_VERSION_DAY		08			//<! Integer, release date day
