...
public:
	...
	virtual  bool fillCubeMeshVI(SGTVertex_PC1T* vertices, u32 vcount, u16* indices, u32 icount, 
	...
	virtual bool fillSphereMeshVI(SGTVertex_PC1T* vertices, u32 vcount, u16* indices, u32 icount,
		f32 radius = 5.f,
	...
	virtual bool fillSkyDomeMeshVI(SGTVertex_PC1T* vertices, u32 vcount, u16* indices, u32 icount,
		u32 horiRes, u32 vertRes, f32 texturePercentage, f32 spherePercentage, f32 radius, SColor color = SColor()) = 0;
	virtual bool fillSkyDomeMeshVI(SGVertex_PC* gVertices, u32 vcount, u16* indices, u32 icount,
		u32 horiRes, u32 vertRes, f32 spherePercentage, f32 radius, SColor color=SColor()) = 0;
	virtual aabbox3df getSkyDomeMeshAABBox(u32 horiRes, u32 vertRes, f32 spherePercentage, f32 radius) = 0;

	virtual u32 getGridLineVCount(u32 xzCount) = 0;
	virtual bool fillGridLineMeshV(SGVertex_PC* gVertices, u32 vcount, u32 xzCount, f32 gridSize, SColor color) = 0;
