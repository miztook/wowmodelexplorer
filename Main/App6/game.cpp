...
void createScene()
{
	...
	//human
	{
		IFileM2* m2HumanMale= g_Engine->getResourceLoader()->loadM2("Character\\HUMAN\\MALE\\HumanMale.m2");
	...
	//nightelf
	{
		IFileM2* m2NightElfMale= g_Engine->getResourceLoader()->loadM2("Character\\NIGHTELF\\MALE\\NightElfMale.m2");
	...
	//dwarf
	{
		IFileM2* m2DwarfMale= g_Engine->getResourceLoader()->loadM2("Character\\DWARF\\MALE\\DwarfMale.m2");
	...
	//gnome
	{
		IFileM2* m2GnomeMale= g_Engine->getResourceLoader()->loadM2("Character\\GNOME\\MALE\\GnomeMale.m2");
	...
	//draenei
	{
		IFileM2* m2DraeneiMale= g_Engine->getResourceLoader()->loadM2("Character\\DRAENEI\\MALE\\DraeneiMale.m2");
	...
	//worgen
	{
		IFileM2* m2WorgenMale= g_Engine->getResourceLoader()->loadM2("Character\\WORGEN\\MALE\\WorgenMale.m2");
	...
	//orc
	{
		IFileM2* m2OrcMale= g_Engine->getResourceLoader()->loadM2("Character\\ORC\\MALE\\OrcMale.m2");
	...
	//tauren
	{
		IFileM2* m2TaurenMale= g_Engine->getResourceLoader()->loadM2("Character\\TAUREN\\MALE\\TaurenMale.m2");
	...
	//scourge
	{
		IFileM2* m2ScourgeMale= g_Engine->getResourceLoader()->loadM2("Character\\SCOURGE\\MALE\\ScourgeMale.m2");
	...
	//troll
	{
		IFileM2* m2TrollMale= g_Engine->getResourceLoader()->loadM2("Character\\TROLL\\MALE\\TrollMale.m2");
	...
	//bloodelf
	{
		IFileM2* m2BloodElfMale= g_Engine->getResourceLoader()->loadM2("Character\\BLOODELF\\MALE\\BloodElfMale.m2");
	...
	//goblin
	{
		IFileM2* m2GoblinMale= g_Engine->getResourceLoader()->loadM2("Character\\GOBLIN\\MALE\\GoblinMale.m2");
