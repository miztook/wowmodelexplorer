...
ACTIONBARS_LABEL = "动作条|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
APPLY = "应用";
APPRENTICE = "初级";
ARCANE_CHARGES = "奥术 |4Charge:充能;";
ARCANE_CHARGES_COST = "%d层奥术充能";
ARCANE_CHARGES_COST_PER_TIME = "%d层奥术充能，外加每秒%d层";
ARCANE_CHARGES_COST_PER_TIME_NO_BASE = "每秒%d层奥术充能";
...
ARENA_MASTER_NO_SEASON_TEXT = "竞技场和评级战场的战斗只在PVP赛季中开放。新的赛季即将开放！|n|n5.4补丁最新特性：没有竞技场队伍的玩家也可以加入竞技场队列了。";
...
AT_WAR = "交战状态";
AUCTIONS = "拍卖";
AUCTION_BUYOUT_ERROR = "一口价必须高于或等于起价。";
...
BALANCE_NEGATIVE_ENERGY_COST = "%d月亮能量";
BALANCE_POSITIVE_ENERGY = "太阳能量";
BALANCE_POSITIVE_ENERGY_COST = "%d太阳能量";
...
BATTLEGROUND_BONUS_REWARD = "战利品掷骰";
BATTLEGROUND_BONUS_REWARD_TOOLTIP = "在奖励战场中比赛将使你获得一次战利品掷骰的机会。赢得比赛将使你额外获得一次战利品掷骰的机会。";
...
BATTLENET_OPTIONS_LABEL = "战网";
BATTLENET_OPTIONS_SUBTEXT = "这些选项可以使你改变接收到的战网信息的类型。";
BATTLENET_UNAVAILABLE = "战网不可用";
BATTLENET_UNAVAILABLE_ALERT = "战网服务暂时不可用。\n\n你的实名和战网昵称好友无法显示，你也无法发送或收到实名和战网昵称好友邀请。也许需要重启游戏以重新启用战网功能。";
BATTLETAG = "战网昵称";
BATTLETAG_CREATE = "创建";
BATTLETAG_CREATE_INFO = "在添加战网昵称好友前，你必须先创建自己的战网昵称。点击“创建”开始创建。";
BATTLETAG_CREATE_WEBSITE = "点击“创建”将打开战网页面。";
...
BATTLE_PETS_TOTAL_PETS_TOOLTIP = "拥有的宠物总数。你最多可拥有1000只宠物，同一种宠物最多可拥有3只。";
...
BINDING_NAME_TOGGLECOLLECTIONSTOYBOX = "打开/关闭玩具盒";
...
BINDING_NAME_TOGGLEENCOUNTERJOURNAL = "打开/关闭地下城手册";
...
BINDING_NAME_TOGGLESELFMUTE = "打开/关闭自我禁声";
...
BINDING_NAME_TOGGLETOYBOX = "打开/关闭玩具盒";
...
BLACK_MARKET_AUCTION_CONFIRMATION = "你想要竞价：";
...
BN_BLOCK_FAILED_TOO_MANY_CID = "你通过战网屏蔽的角色数量已达上限。";
BN_BLOCK_FAILED_TOO_MANY_RID = "你能够屏蔽的实名和战网昵称好友已达上限。";
BN_BROADCAST_TOOLTIP = "向你的实名或战网昵称好友发送通告信息。";
BN_CHAT_CONNECTED = "你已连接到战网。";
BN_CHAT_DISCONNECTED = "你已断开与战网的连接。";
BN_CONVERSATION = "实名对话";
BN_INLINE_TOAST_ALERT = "战网提示";
BN_INLINE_TOAST_BATTLETAG_FRIEND_ADDED = "\124TInterface\\FriendsFrame\\UI-Toast-ToastIcons.tga:16:16:0:0:128:64:98:127:2:29\124t%s现在是你的战网昵称好友。";
BN_INLINE_TOAST_BATTLETAG_FRIEND_REMOVED = "\124TInterface\\FriendsFrame\\UI-Toast-ToastIcons.tga:16:16:0:0:128:64:2:29:34:61\124t%s不再是你的战网昵称好友。";
...
BONUS_REWARDS = "额外奖励";
BONUS_ROLL_COST = "消耗：%d \124T%s:14\124t";
...
BURNING_EMBERS = "爆燃灰烬";
BURNING_EMBERS_COST = "%d 爆燃灰烬";
BURNING_EMBERS_COST_PER_TIME = "%d团爆燃灰烬，外加每秒%d团";
BURNING_EMBERS_COST_PER_TIME_NO_BASE = "每秒%d个爆燃灰烬";
...
CALENDAR_ERROR_MODERATOR_RESTRICTED = "试玩账号无法修改活动日历。";
...
CALENDAR_FILTERS = "过滤";
CALENDAR_FILTER_BATTLEGROUND = "战斗的召唤";
...
CAPACITANCE_FOLLOWER_BONUS_ACTIVE = "|cff00ff00激活追随者奖励！|r";
...
CAPACITANCE_SHIPMENT_COUNT = "可接收的产品订单：%d/%d";
CAPACITANCE_SHIPMENT_READY = "货物准备就绪，可以接收了！";
CAPACITANCE_START_WORK_ORDER = "启动产品订单";
...
CHALLENGE_MODE_MEDAL1 = "青铜级";
CHALLENGE_MODE_MEDAL2 = "白银级";
CHALLENGE_MODE_MEDAL3 = "黄金级";
CHALLENGE_MODE_MEDALNAME1 = "青铜奖章";
CHALLENGE_MODE_MEDALNAME2 = "白银奖章";
CHALLENGE_MODE_MEDALNAME3 = "黄金奖章";
CHALLENGE_MODE_NEW_BEST = "%s - 新纪录！";
...
CHARACTER_UPGRADE_READY = "您的角色已经可以直升90级了！";
...
CHAT_CHANNEL_LIST_GET = "|Hchannel:频道:%d|h[%s]|h\32";
...
CHAT_IGNORED = "%s已将你屏蔽。";
CHAT_INSTANCE_CHAT_GET = "|Hchannel:INSTANCE_CHAT|h[副本]|h %s：\32";
CHAT_INSTANCE_CHAT_LEADER_GET = "|Hchannel:INSTANCE_CHAT|h[副本向导]|h %s：\32";
CHAT_INSTANCE_CHAT_SEND = "副本：\32";
...
CHAT_PET_BATTLE_COMBAT_LOG_GET = "|Hchannel:PET_BATTLE_COMBAT_LOG|h[宠物对战]|h：\32";
CHAT_PET_BATTLE_INFO_GET = "|Hchannel:PET_BATTLE_INFO|h[宠物对战]|h：\32";
...
CHAT_RESTRICTED = "试玩账号只能向已经将你加入好友列表的玩家发送悄悄话。\124cffffd000\124HurlIndex:2\124h[点击此处升级账号]\124h\124r";
CHAT_SAY_GET = "%s说：\32";
CHAT_SAY_SEND = "说：\32";
...
CHAT_TRIAL_RESTRICTED_NOTICE = "|Hchannel:%d|h[%s]|h试玩账号无法使用该频道发送信息。\124cffffd000\124HurlIndex:2\124h[点击此处升级账号]\124h\124r";
...
CHI = "真气";
CHI_COST = "%d点真气";
CHI_COST_PER_TIME = "%d点真气，外加每秒%d点";
CHI_COST_PER_TIME_NO_BASE = "每秒%d点真气";
CHI_POWER = "真气";
...
COLLECTED = "已收集";
COLLECTIONS = "藏品";
COLLECTIONS_MICRO_BUTTON_SPEC_TUTORIAL = "你可以在这里查看所有的坐骑、宠物和玩具！";
...
COMBATLOG_HONORAWARD = "你获得了%.2f点荣誉点数。";
COMBATLOG_HONORGAIN = "%s死亡，荣誉击杀军衔：%s（%.2f荣誉点数）";
COMBATLOG_HONORGAIN_NO_RANK = "%s死亡，荣誉击杀（%.2f 荣誉点数）";
...
COMBAT_TEXT_SHOW_HONOR_GAINED_TEXT = "荣誉击杀";
...
CONFIRM_GLYPH_PLACEMENT_NO_COST = "你确定要铭刻%s吗？已有的雕文将被覆盖。";
...
CONFIRM_JOIN_SOLO = "你正处于队伍中。确定要单独排队吗？";
...
CONFIRM_REMOVE_GLYPH = "你确定要移除%s吗？\n\n%s花费：%d %s|r";
CONFIRM_REMOVE_GLYPH_NO_COST = "你确定要移除%s吗？";
CONFIRM_RESET_CHALLENGE_MODE = "你确定要重置挑战吗？";
...
CONFIRM_TALENT_WIPE_2 = "你确定要遗忘所有的天赋专精吗？";
CONFIRM_TALENT_WIPE_3 = "你确定要遗忘所有的雕文吗？";
CONFIRM_TALENT_WIPE_4 = "你确定要遗忘所有的宠物天赋专精吗？";
...
CONFIRM_UNLEARN_AND_SWITCH_TALENT = "要想学习%s，你必须先移除%s。你确定要这么做吗？\n\n%s花费：%d %s|r";
CONFIRM_UNLEARN_AND_SWITCH_TALENT_NO_COST = "要想学习%s，你必须先移除%s。你确定要这么做吗？";
...
CONTINUE = "继续";
CONTINUED = "……";
CONTROLS_LABEL = "控制|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
CORPSE_TOOLTIP = "%s的尸体";
COSTS_LABEL = "花费：";
COUNTDOWN_FOR_COOLDOWNS_TEXT = "显示冷却时间|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
CRIT_CHANCE = "爆击几率";
CRUSHING_TRAILER = "(碾压)";
CR_AMPLIFY_TOOLTIP = "爆击伤害、急速、精通、迅疾和溅射提高。\n\n增效 %s (+%.2f%% 增效)";
CR_AVOIDANCE_TOOLTIP = "范围效果法术的伤害降低。\n\n闪避：%s [+%.2f%%]";
CR_BLOCK_TOOLTIP = "你的格挡可抵消%d%%的伤害。";
CR_CLEAVE_TOOLTIP = "提高你的范围效果伤害和治疗量，并使你的单体目标技能有一定几率额外命中附近的一个目标。\n\n顺劈 %s (+%.2f%% 顺劈)";
...
CR_READINESS_TOOLTIP = "迅疾 %s (+%.2f%% 迅疾)";
CR_READINESS_TOOLTIP_NO_TALENT_SPEC = "你必须选择一个职业专精才能激活迅疾属性。";
...
CURRENCY_SEASON_TOTAL = "赛季总共获得：%s%d";
CURRENCY_THIS_WEEK = "本周%s";
CURRENCY_THIS_WEEK_WITH_AMOUNT = "本周%s：%d/%d";
CURRENCY_TOTAL_CAP = "总上限：%s%d/%d";
CURRENCY_WEEKLY_CAP = "每周上限：%s%d/%d";
...
DAMAGE_TOOLTIP = "武器伤害";
DARK_FORCE_COST = "%d黑暗劲力";
DARK_FORCE_COST_PER_TIME = "%d黑暗劲力，外加每秒%d";
DARK_FORCE_COST_PER_TIME_NO_BASE = "每秒%d点黑暗劲力";
...
DEFAULT_STAT1_TOOLTIP = "攻击强度提高%s点";
DEFAULT_STAT2_TOOLTIP = "攻击强度提高%s";
DEFAULT_STAT3_TOOLTIP = "生命值提高%s点";
DEFAULT_STAT4_TOOLTIP = "法术强度提高%s";
...
DEMONIC_FURY = "恶魔之怒";
DEMONIC_FURY_COST = "%d点恶魔之怒";
DEMONIC_FURY_COST_PER_TIME = "%d点恶魔之怒，外加每秒%d点";
DEMONIC_FURY_COST_PER_TIME_NO_BASE = "每秒%d点恶魔之怒";
...
DISPLAY_LABEL = "显示|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
DISPLAY_MODE = "显示模式";
...
DK = "非荣誉击杀";
DK_BLOOD_CORE_ABILITY_1 = "当你有1个邪恶符文时使用。";
DK_BLOOD_CORE_ABILITY_2 = "当你有1个冰霜符文时使用。";
DK_BLOOD_CORE_ABILITY_3 = "当你有1个鲜血符文时使用，用于传播疾病。";
DK_BLOOD_CORE_ABILITY_4 = "当你有可用的符文能量时使用。";
DK_BLOOD_CORE_ABILITY_5 = "当你有1个邪恶符文和1个冰霜符文时使用。";
DK_BLOOD_CORE_ABILITY_6 = "当你有1个鲜血符文时使用，用于防御。";
DK_FROST_CORE_ABILITY_1 = "当你有1个邪恶符文时使用。";
DK_FROST_CORE_ABILITY_2 = "当你有1个冰霜符文时使用。";
DK_FROST_CORE_ABILITY_3 = "当你有1个邪恶符文和1个冰霜符文时使用。";
DK_FROST_CORE_ABILITY_4 = "当你有可用的符文能量时使用。";
DK_FROST_CORE_ABILITY_5 = "当你有1个冰霜符文且目标濒临死亡时使用。";
DK_UNHOLY_CORE_ABILITY_1 = "当你有1个邪恶符文时使用。";
DK_UNHOLY_CORE_ABILITY_2 = "当你有1个鲜血符文和1个冰霜符文时使用，用于延续目标身上的疾病持续时间。";
DK_UNHOLY_CORE_ABILITY_3 = "当你有可用的符文能量时使用。";
DK_UNHOLY_CORE_ABILITY_4 = "当你有1个冰霜符文且目标濒临死亡时使用。";
DK_UNHOLY_CORE_ABILITY_5 = "随时保持食尸鬼的存在。";
DK_UNHOLY_CORE_ABILITY_6 = "在可用时转化你的食尸鬼。";
DMG = "Dmg";
DND = "忙碌";
DODGE = "躲闪";
DODGE_CHANCE = "躲闪几率";
...
DRUID_BALANCE_CORE_ABILITY_1 = "可用时，保持目标身上一直有此效果。";
DRUID_BALANCE_CORE_ABILITY_2 = "可用时，保持目标身上一直有此效果。";
DRUID_BALANCE_CORE_ABILITY_3 = "当太阳能量较强时使用。";
DRUID_BALANCE_CORE_ABILITY_4 = "当月亮能量较强时使用。";
DRUID_BALANCE_CORE_ABILITY_5 = "可用时使用，以提高愤怒或星火术的伤害。";
DRUID_BALANCE_CORE_ABILITY_6 = "被动技能。使在月亮和太阳能量间轮转的法术变得更强大。";
DRUID_FERAL_CORE_ABILITY_1 = "保持目标身上一直有此效果。";
DRUID_FERAL_CORE_ABILITY_2 = "用于积累连击点数。";
DRUID_FERAL_CORE_ABILITY_3 = "当你有5个连击点数时，保持自己身上一直有此效果。";
DRUID_FERAL_CORE_ABILITY_4 = "当你有5个连击点数时，保持目标身上一直有此效果。";
DRUID_FERAL_CORE_ABILITY_5 = "当你有5个连击点数并且其他终结技的效果还未结束时使用。";
DRUID_GUARDIAN_CORE_ABILITY_1 = "可用时使用，用来产生怒气。";
DRUID_GUARDIAN_CORE_ABILITY_2 = "保持目标身上一直有此效果。";
DRUID_GUARDIAN_CORE_ABILITY_3 = "保持目标身上一直有此效果。";
DRUID_GUARDIAN_CORE_ABILITY_4 = "用怒气造成额外伤害。";
DRUID_GUARDIAN_CORE_ABILITY_5 = "当你有60点怒气时使用，用于防御。";
DRUID_GUARDIAN_CORE_ABILITY_6 = "用怒气治疗你自己。";
DRUID_INTELLECT_TOOLTIP = "提高你的法力值上限和法术的爆击几率。\n使你更快地提升武器技能熟练度。";
DRUID_RESTO_CORE_ABILITY_1 = "保持主要治疗目标身上一直有此效果。";
DRUID_RESTO_CORE_ABILITY_2 = "用于治疗多个受伤的目标。";
DRUID_RESTO_CORE_ABILITY_3 = "缓慢但低消耗的治疗技能。";
DRUID_RESTO_CORE_ABILITY_4 = "快速但高消耗的治疗技能。";
DRUID_RESTO_CORE_ABILITY_5 = "当许多队员受伤时使用。";
DRUID_RESTO_CORE_ABILITY_6 = "可频繁使用，进行快速治疗。";
...
DUNGEON_FLOOR_FROSTFIRERIDGE7 = "蛮荒峭壁";
...
ENERGY_COST_PER_TIME_NO_BASE = "每秒%d点能量";
ENGB = "英语（EU）";
ENGRAVE = "铭刻";
ENSCRIBE = "附魔";
...
ERR_AUTH_CHALLENGE_UI_INVALID = "[PH]目前无法完成该动作。|n请关闭你的插件后重试。";
...
ERR_BATTLETAG_FRIEND_REQUEST_SENT = "战网昵称好友请求已发送";
...
ERR_BN_FRIEND_LIST_FULL = "你的战网好友列表已满。";
...
ERR_CHALLENGE_MODE_FULL = "一个挑战模式副本中最多可容纳5名不同的玩家。重置副本将同时重置该计数器。";
...
ERR_CHAT_RESTRICTED = "试玩账号不能频繁发送信息，你必须稍作等待才能再次发言。\124cffffd000\124HurlIndex:2\124h[点击此处升级账号]\124h\124r";
...
ERR_GUILD_TRIAL_ACCOUNT = "试玩账号无法使用该功能。";
...
ERR_INVITE_RESTRICTED = "试玩账号无法邀请其他角色进行组队。\124cffffd000\124HurlIndex:2\124h[点击此处升级账号]\124h\124r";
...
ERR_LEARN_TOY_S = "你已经将玩具%s添加到了你的收藏中。";
ERR_LEFT_GROUP_S = "%s离开了队伍。";
ERR_LEFT_GROUP_YOU = "你离开了队伍。";
ERR_LEGACY_RAID_DIFFICULTY_CHANGED_S = "已将经典旧世团队副本难度设置为%s。";
ERR_LEGACY_RAID_DIFFICULTY_FAILED = "无法更改经典旧世团队副本难度。";
...
ERR_NO_LOOT_IN_CHALLENGE_MODE = "在挑战模式地下城中你不能拾取装备。";
ERR_NO_PET = "你现在还没有宠物！";
...
ERR_PARENTAL_CONTROLS_CHAT_MUTED = "你当前的家长监控设定禁止发送或接收聊天信息。";
...
ERR_PETBATTLE_QUEUE_SLOT_LOCKED = "战斗宠物栏位%d已解锁。";
...
ERR_PETITION_RESTRICTED_ACCOUNT = "试玩账号无法签署公会登记表。\124cffffd000\124HurlIndex:2\124h[点击此处升级账号]\124h\124r";
...
ERR_QUEST_PET_BATTLE_VICTORIES_PVP_II = "在宠物战斗中失利的玩家：%d/%d";
...
ERR_REFORGE_ALREADY_HAS_DST_STAT = "这件物品已经有那项属性了";
ERR_REFORGE_INSUFFICIENT_SRC_STAT = "你不能重铸那件物品";
ERR_REFORGE_ITEM_TOO_LOW_LEVEL = "物品等级必须达到或高于200级";
ERR_REFORGE_SRC_STAT_NOT_FOUND = "你无法重铸该物品";
...
ERR_RESTRICTED_ACCOUNT = "试玩账号无法进行此项操作";
ERR_RESTRICTED_ACCOUNT_LFG_LIST = "试玩账号无法使用此功能。";
...
ERR_YELL_RESTRICTED = "试玩账号不能进行呼喊（/y）。\124cffffd000\124HurlIndex:2\124h[点击此处升级账号]\124h\124r";
...
FLIGHT_MAP = "飞行地图";
FLOATING_COMBATTEXT_LABEL = "浮动战斗信息|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
FLOATING_COMBAT_PETBATTLE_LABEL = "宠物对战的浮动战斗信息|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
GARRISON_BUILDING_NO_FOLLOWERS = "你的所有追随者都没有匹配该建筑的特长。";
...
GARRISON_CHOOSE_TRAIT = "选择一项特长";
GARRISON_CONFIRM_RECRUIT_FOLLOWER = "确定要招募%s吗？";
GARRISON_CURRENT_LEVEL = "等级%d";
...
GARRISON_FINALIZE_BUILDING_TOOLTIP = "返回建筑工地验收建筑竣工。";
GARRISON_FOLLOWERS = "追随者";
GARRISON_FOLLOWERS_TITLE = "要塞追随者";
GARRISON_FOLLOWER_ADDED = "%s成为你的追随者。";
...
GARRISON_LANDING_NEXT = "（下一次：%s）";
GARRISON_LANDING_PAGE_TITLE = "要塞报告";
GARRISON_LANDING_RETURN = "%d准备接收";
GARRISON_LANDING_SHIPMENT_COUNT = "%d/%d";
GARRISON_LANDING_SHIPMENT_LABEL = "产品订单";
GARRISON_LANDING_SHIPMENT_READY_TO_START = "%d份准备完毕";
...
GARRISON_MISSION_ENVIRONMENT_TOOLTIP = "拥有适合该任务类型的特长的追随者可以提高你获得任务奖励宝箱的几率。";
...
GARRISON_RECRUIT_TRAIT = "特长";
GARRISON_RECRUIT_TRAITS = "特长";
...
GARRISON_SHIPMENT_IN_PROGRESS = "生产中的货物";
GARRISON_SHIPMENT_READY = "货物准备就绪";
...
GARRISON_TRAITS = "特长";
GARRISON_TROPHY_LOCKED_SUBTEXT = "成就奖励：";
...
GUILD_ACHIEVEMENTS_ELIGIBLE_MAXXP = "你的队伍是完全由%1$s公会的成员构成的。该队伍能够解开公会成就并且能以标准值的%2$d%%获得公会经验值。";
GUILD_ACHIEVEMENTS_ELIGIBLE_MINXP = "在你队伍的%2$d名玩家中有至少%1$d人是%3$s公会的成员。该队伍能够解开公会成就并且能以%4$d%%的标准速度获得公会经验值。";
...
GUILD_CHALLENGE_LABEL5 = "公会挑战模式 - 地下城挑战";
...
GUILD_CHALLENGE_TOOLTIP1 = "在公会队伍中完成任意与等级相符的普通或英雄地下城副本。";
...
GUILD_CHALLENGE_TOOLTIP5 = "在公会队伍中完成任意与等级相符的挑战模式地下城。";
...
GUILD_INTEREST_RAID_TOOLTIP = "团队副本和地下城很接近，只是它所带来的挑战更艰巨。团队副本需要10人到25人组团完成，通常也比地下城大得多。";
...
GUILD_LEVEL_UP = "恭喜\"%s\"升到了|cffFF4E00|Hlevelup:%d:LEVEL_UP_TYPE_GUILD|h[%d级]|h|r！";
GUILD_LEVEL_UP_PERK = "新公会福利！";
GUILD_LEVEL_UP_PERK2 = "新公会福利：";
GUILD_LEVEL_UP_YOU_REACHED = "|cffffd100%s|r达到";
...
HEALTH_COLON = "生命值：";
HEALTH_COST = "%d生命值";
HEALTH_COST_PCT = "%d%%最大生命值";
HEALTH_COST_PER_TIME = "%d生命值，每秒增加%d";
HEALTH_COST_PER_TIME_NO_BASE = "每秒%d点生命值";
HEALTH_LOW = "生命值过低";
...
HELPFRAME_ACCOUNTSECURITY_TEXT2 = "分享你的账号信息可能会让你丢掉崭新耀眼的史诗装备！保护你的密码，否则你的账号就真的危险了，甚至可能导致账号被盗。我们建议你为你的战网通行证设置一个单独的密码。";
...
HELPFRAME_ACCOUNT_ENDTEXT = "想要联系任何此类问题，请联系支付和帐户服务：|n|n通过网站：|cffffd200http://www.warcraftchina.com/support|r|n电子邮件：|cffffd200billing@battlenet.com.cn|r|n|n我们还建议您访问账号管理页面：|n|n|cffffd200www.battlenet.com.cn|r |n|n在账号管理页面，您可以查看您的缴费信息、进行充卡和使用其他重要的账号功能。";
...
HELPFRAME_OPENTICKETINSTRUCTIONS_TEXT1 = "GM能够24小时为您提供协助。无论您当前进行游戏的是哪个角色，GM都能与你取得联系。每个账号同一时间只能发送一个帮助请求。敬请留意，等待的时间也许会不尽相同。";
HELPFRAME_OPENTICKETINSTRUCTIONS_TEXT2 = "在填写申请之前，请花费少许时间阅读客服支持选单下的|cffffd200[重要问题]|r栏。您可以点击画面下方菜单中的|cffffd200[?]|r按钮来开启该选单。";
...
HUNTER_BM_CORE_ABILITY_1 = "当没有其它技能可用时使用。";
HUNTER_BM_CORE_ABILITY_2 = "当你的集中值较低时使用。";
HUNTER_BM_CORE_ABILITY_3 = "当你有5层狂乱效果时使用。";
HUNTER_BM_CORE_ABILITY_4 = "可用时使用。";
HUNTER_BM_CORE_ABILITY_5 = "当目标濒临死亡时使用。";
HUNTER_INTELLECT_TOOLTIP = "提高你的法力值上限和法术的爆击几率。\n使你更快地提升武器技能熟练度。";
HUNTER_MM_CORE_ABILITY_1 = "当没有其它技能可用时使用。";
HUNTER_MM_CORE_ABILITY_2 = "可用时使用，尤其是在打击2个目标时。";
HUNTER_MM_CORE_ABILITY_3 = "当你的集中值较低时使用。";
HUNTER_MM_CORE_ABILITY_4 = "当目标濒临死亡时使用。";
HUNTER_SV_CORE_ABILITY_1 = "保持目标身上一直有此效果。";
HUNTER_SV_CORE_ABILITY_2 = "可用时使用。";
HUNTER_SV_CORE_ABILITY_3 = "当你的集中值较低时使用。";
HUNTER_SV_CORE_ABILITY_4 = "当没有其它技能可用时使用。";
...
INSTANCE_UNAVAILABLE_OTHER_GEAR_TOO_HIGH = "%s需要降低平均装备物品等级。（需要：%2$d。当前%3$d。）";
INSTANCE_UNAVAILABLE_OTHER_GEAR_TOO_LOW = "%s需要更高的平均装备物品等级。（需要：%2$d。当前%3$d。）";
...
ITEM_BIND_TO_BNETACCOUNT = "绑定至战网通行证";
ITEM_BNETACCOUNTBOUND = "战网通行证绑定";
...
ITEM_COMPARISON_CYCLING_DISABLED_MSG_MAINHAND = "访问快捷键菜单，开启主手物品的的循环比较。";
ITEM_COMPARISON_CYCLING_DISABLED_MSG_OFFHAND = "访问快捷键菜单，开启副手物品的的循环比较。";
...
ITEM_MOD_HASTE_MELEE_RATING = "近战急速提高%s点。";
ITEM_MOD_HASTE_MELEE_RATING_SHORT = "急速（近战）";
ITEM_MOD_HASTE_RANGED_RATING = "远程急速提高%s点。";
ITEM_MOD_HASTE_RANGED_RATING_SHORT = "急速（远程）";
ITEM_MOD_HASTE_RATING = "使你的急速提高%s点。";
ITEM_MOD_HASTE_RATING_SHORT = "急速";
ITEM_MOD_HASTE_SPELL_RATING = "法术急速提高%s点。";
ITEM_MOD_HASTE_SPELL_RATING_SHORT = "急速（法术）";
...
ITEM_REQ_ARENA_RATING_3V3 = "需要3v3或5v5的个人竞技场等级达到%d|n";
ITEM_REQ_ARENA_RATING_3V3_BG = "需要战场等级达到%d或者|n3v3/5v5的个人|n竞技场等级达到%d";
...
ITEM_SET_BONUS_NO_VALID_SPEC = "激活天赋专精，显示其套装奖励";
ITEM_SET_NAME = "%s（%d/%d）";
...
ITEM_UPGRADE_DESCRIPTION = "消耗你的荣誉、正义、征服或勇气点数以升级一件物品等级不低于458的武器或护甲。";
...
LASTONLINE = "最后上线";
LASTONLINE_DAYS = "%d天前";
LASTONLINE_HOURS = "%d小时前";
LASTONLINE_MINS = "<1个小时前";
...
LEAVING_COMBAT = "脱离战斗";
LEFT_PARTY = "%s离开了队伍。";
LEGACY_RAID_DIFFICULTY = "经典旧世团队副本难度";
...
LEVEL_UP_CHAR_POINTS = "你获得了%d个|4talent:天赋;。";
...
LEVEL_UP_SPECIALIZATION_LINK = "|cffFF4E00|Htalentpane:|h[专精]|h|r";
...
LFG_LIST_BAD_DESCRIPTION = "不当的描述";
LFG_LIST_BAD_LEADER_NAME = "不当队长名";
LFG_LIST_BAD_NAME = "不当队伍名";
...
LFG_LIST_ENTRY_DELISTED = "这个队伍已经不需要更多队员了。";
...
LIGHT_FORCE = "光明劲力";
LIGHT_FORCE_COST = "%d光明劲力";
LIGHT_FORCE_COST_PER_TIME = "%d光明劲力，外加每秒%d";
LIGHT_FORCE_COST_PER_TIME_NO_BASE = "每秒%d点光明劲力";
...
LOOT_ROLL_WON_NO_SPAM_NEED = "|HlootHistory:%d|h[战利品]|h：%s(需求 - %d)赢得了：%s";
...
LOOT_ROLL_YOU_WON_NO_SPAM_NEED = "|HlootHistory:%d|h[战利品]|h：你(需求 - %d)赢得了：%s";
...
MAGE_ARCANE_CORE_ABILITY_1 = "主要伤害法术，可产生奥术充能。";
MAGE_ARCANE_CORE_ABILITY_2 = "当你有4层奥术充能，或法术消耗太大时使用。";
MAGE_ARCANE_CORE_ABILITY_3 = "可用时施放。";
MAGE_ARCANE_CORE_ABILITY_4 = "被动技能。使你的法术伤害和法力消耗提高。";
MAGE_ARCANE_CORE_ABILITY_5 = "当法力值低于40% 时使用，可恢复法力值";
MAGE_FIRE_CORE_ABILITY_1 = "主要的伤害法术。";
MAGE_FIRE_CORE_ABILITY_2 = "当其可瞬发时使用。";
MAGE_FIRE_CORE_ABILITY_3 = "在出现爆击后使用，以使下一个炎爆术瞬发。或者为了扩散持续性火焰伤害而使用该技能。";
MAGE_FIRE_CORE_ABILITY_4 = "用于在移动时造成伤害。";
MAGE_FIRE_CORE_ABILITY_5 = "在炎爆术后使用，提高持续性火焰伤害。";
MAGE_FROST_CORE_ABILITY_1 = "主要的伤害法术。";
MAGE_FROST_CORE_ABILITY_2 = "当目标被冻结时使用。";
MAGE_FROST_CORE_ABILITY_3 = "当冰冷智慧触发时使用。";
MAGE_FROST_CORE_ABILITY_4 = "随时保持水元素的存在。";
MAGE_FROST_CORE_ABILITY_5 = "被动技能。使你的霜火之箭有时能变成瞬发并造成更多伤害。";
MAGE_FROST_CORE_ABILITY_6 = "被动技能。使你的冰枪术有时能造成更多伤害。";
...
MANA_COST_PER_TIME_NO_BASE = "每秒%d点法力值";
MANA_LOW = "法力值过低";
MANA_REGEN = "法力回复";
MANA_REGEN_ABBR = "Regen";
MANA_REGEN_COMBAT = "战斗回复";
MANA_REGEN_FROM_SPIRIT = "战斗状态下的法力值恢复速度%d";
...
MONEY_COLON = "金钱：";
MONEY_LOOT = "金钱拾取";
MONK_BREW_CORE_ABILITY_1 = "可用时使用，用来产生真气。";
MONK_BREW_CORE_ABILITY_2 = "用于产生真气。";
MONK_BREW_CORE_ABILITY_3 = "消耗两点真气以减少伤害。";
MONK_BREW_CORE_ABILITY_4 = "当没有其它技能可用时使用。";
MONK_BREW_CORE_ABILITY_5 = "当承受大量伤害后使用，主要的真气消耗技能。";
MONK_BREW_CORE_ABILITY_6 = "当需要防御时使用。";
MONK_MIST_CORE_ABILITY_1 = "缓慢但低消耗的治疗技能。";
MONK_MIST_CORE_ABILITY_2 = "快速但高消耗的治疗技能，能够与抚慰之雾叠加。";
MONK_MIST_CORE_ABILITY_3 = "强大的治疗技能，能够与抚慰之雾叠加。";
MONK_MIST_CORE_ABILITY_4 = "当需要治疗自己并对附近一名敌人造成伤害时使用。";
MONK_MIST_CORE_ABILITY_5 = "当有多个队员受伤时使用。";
MONK_MIST_CORE_ABILITY_6 = "当许多受伤目标身上有你的复苏之雾时使用。";
MONK_WIND_CORE_ABILITY_1 = "用于产生真气。";
MONK_WIND_CORE_ABILITY_2 = "保持自己身上一直有此效果。";
MONK_WIND_CORE_ABILITY_3 = "当你拥有2点真气时使用。";
MONK_WIND_CORE_ABILITY_4 = "可用时使用。";
MONK_WIND_CORE_ABILITY_5 = "可用时使用。";
MONK_WIND_CORE_ABILITY_6 = "当你有10层虎眼酒效果时使用。";
...
MUTE_PLAYER = "禁声玩家";
NAME = "名字";
NAMES_LABEL = "名字|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
NPE_RELEASESPIRIT = "你死了。|cFF00FFFF左键点击|r该按钮继续。";
...
NPE_USEHEARTHSTONE = "|cFF00FFFF右键点击|r{Atlas|NPE_RightClick:16}背包中的炉石|TInterface\\Icons\\inv_misc_rune_01:16|t传送回你的家。";
...
OBJECT_NPC_OUTLINE = "轮廓线模式|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
OPTION_TOOLTIP_COUNTDOWN_FOR_COOLDOWNS = "勾选此项后，动作条上的按钮将以倒计时数字，而非指针转动方式显示冷却时间。";
...
OPTION_TOOLTIP_DISPLAY_SPELL_ALERTS = "在你的屏幕中央显示特定重要事件的报警信息。";
...
OPTION_TOOLTIP_SHOW_BATTLE_PET_TAMERS_ON_MAP = "启用后你可以在地图上看到战斗宠物训练师的位置。";
OPTION_TOOLTIP_SHOW_BORDERS = "显示团队框体的边框。";
OPTION_TOOLTIP_SHOW_BOSSES_ON_MAP = "启用后你可以在地图上看到战斗宠物训练师的位置。";
...
OPTION_TOOLTIP_SHOW_DIG_SITES_ON_MAP = "开启该选项将使你能够在地图上查看考古挖掘场的位置。";
...
OPTION_TOOLTIP_SHOW_TOAST_BROADCAST = "实名好友或战网昵称好友更新通告时显示战网信息。";
OPTION_TOOLTIP_SHOW_TOAST_CONVERSATION = "加入实名或战网昵称好友对话时显示战网信息。";
OPTION_TOOLTIP_SHOW_TOAST_FRIEND_REQUEST = "收到实名好友或战网昵称好友请求时显示战网信息。";
OPTION_TOOLTIP_SHOW_TOAST_OFFLINE = "实名好友或战网昵称好友下线时显示战网信息。";
OPTION_TOOLTIP_SHOW_TOAST_ONLINE = "实名好友或战网昵称好友上线时显示战网信息。";
...
OPTION_TOOLTIP_UNIT_NAMEPLATES_SHOW_ENEMIES = "选中此选项可以显示敌人的姓名板。";
...
OPTION_TOOLTIP_UNIT_NAMEPLATES_SHOW_ENEMY_PETS = "选中此选项可以显示敌人宠物的姓名板。";
...
OPTION_TOOLTIP_UNIT_NAMEPLATES_SHOW_FRIENDLY_PETS = "选中此选项可以显示友方宠物的姓名板。";
OPTION_TOOLTIP_UNIT_NAMEPLATES_SHOW_FRIENDLY_TOTEMS = "选中该选项以显示友方图腾的姓名板。";
OPTION_TOOLTIP_UNIT_NAMEPLATES_SHOW_FRIENDS = "选中此选项可以显示友方单位的姓名板。";
...
OVERVIEW_TANK = "坦克综述";
PAGE_NUMBER = "第%d页";
PALADIN_HOLY_CORE_ABILITY_1 = "用于治疗并生成1点神圣能量。";
PALADIN_HOLY_CORE_ABILITY_2 = "当你有3层神圣能量时使用，用于治疗。";
PALADIN_HOLY_CORE_ABILITY_3 = "缓慢但低消耗的治疗技能。";
PALADIN_HOLY_CORE_ABILITY_4 = "快速但高消耗的治疗技能。";
PALADIN_HOLY_CORE_ABILITY_5 = "当需要同时治疗两个目标时使用。";
PALADIN_HOLY_CORE_ABILITY_6 = "当许多队员受伤时使用。";
PALADIN_INTELLECT_TOOLTIP = "提高你的法力值上限和法术的爆击几率。\n使你更快地提升武器技能熟练度。";
PALADIN_PROT_CORE_ABILITY_1 = "可用时使用。";
PALADIN_PROT_CORE_ABILITY_2 = "可用时使用。用于生成1点神圣能量。";
PALADIN_PROT_CORE_ABILITY_3 = "可用时使用。用于生成1点神圣能量。";
PALADIN_PROT_CORE_ABILITY_4 = "当你有神圣能量并想将其用于治疗时使用。";
PALADIN_PROT_CORE_ABILITY_5 = "当你有3层神圣能量时使用，用于防御以及提高荣耀圣令效果。";
PALADIN_PROT_CORE_ABILITY_6 = "在与单个敌人战斗时保持激活状态。";
PALADIN_RET_CORE_ABILITY_1 = "可用时使用。用于生成1点神圣能量。";
PALADIN_RET_CORE_ABILITY_2 = "可用时使用。用于生成1点神圣能量。";
PALADIN_RET_CORE_ABILITY_3 = "当你有3层神圣能量时使用。";
PALADIN_RET_CORE_ABILITY_4 = "可用时使用。";
PALADIN_RET_CORE_ABILITY_5 = "当目标濒临死亡时使用。";
PALADIN_RET_CORE_ABILITY_6 = "在与单个敌人战斗时保持激活状态。";
...
POWER_DISPLAY_COST_PER_TIME_NO_BASE = "每秒%d%s";
POWER_GAINS = "获得能量";
POWER_GAINS_COMBATLOG_TOOLTIP = "当法术或技能恢复法力、能量、怒气、集中值、真气、神圣能量或暗影宝珠时显示信息。";
...
PREVIOUS = "返回";
PRIEST_DISC_CORE_ABILITY_1 = "可用时使用，用来治疗单个目标。";
PRIEST_DISC_CORE_ABILITY_2 = "瞬发的高消耗伤害吸收技能。";
PRIEST_DISC_CORE_ABILITY_3 = "缓慢但低消耗的治疗技能。";
PRIEST_DISC_CORE_ABILITY_4 = "快速但高消耗的治疗技能。";
PRIEST_DISC_CORE_ABILITY_5 = "瞬发的低治疗量技能，当附近有许多受伤目标时使用。";
PRIEST_DISC_CORE_ABILITY_6 = "缓慢的治疗技能，当有许多受伤目标时使用。";
PRIEST_HOLY_CORE_ABILITY_1 = "缓慢但低消耗的治疗技能。";
PRIEST_HOLY_CORE_ABILITY_2 = "快速但高消耗的治疗技能。";
PRIEST_HOLY_CORE_ABILITY_3 = "用于治疗多个受伤的目标。";
PRIEST_HOLY_CORE_ABILITY_4 = "当有多个队员承受伤害时使用。";
PRIEST_HOLY_CORE_ABILITY_5 = "瞬发的冷却型治疗技能，当有许多受伤目标时使用。";
PRIEST_HOLY_CORE_ABILITY_6 = "缓慢的治疗技能，当有许多受伤目标时使用。";
PRIEST_INTELLECT_TOOLTIP = "提高你的法力值上限和法术的爆击几率。\n使你更快地提升武器技能熟练度。";
PRIEST_SHADOW_CORE_ABILITY_1 = "保持目标身上一直有此效果。";
PRIEST_SHADOW_CORE_ABILITY_2 = "保持目标身上一直有此效果。";
PRIEST_SHADOW_CORE_ABILITY_3 = "可用时使用。是主要的暗影宝珠生成手段。";
PRIEST_SHADOW_CORE_ABILITY_4 = "当没有其它技能可用时使用。";
PRIEST_SHADOW_CORE_ABILITY_5 = "当你有3层暗影宝珠时使用。";
PRIEST_SHADOW_CORE_ABILITY_6 = "当目标濒临死亡时使用。";
PRIMARY = "主要";
PRIMARY_MONITOR = "显示器";
PRIMARY_SKILLS = "主要技能：";
PRIME_GLYPH = "首要雕文";
...
QUEST_MONSTERS_KILLED = "%2$d/%3$d 已消灭%1$s";
...
QUEST_PLAYERS_KILLED = "%1$d/%2$d 已击败%3$s个玩家";
...
QUEUED_STATUS_IN_PROGRESS = "|cff19ff19[进行中]|r";
...
RAGE_COST_PER_TIME_NO_BASE = "每秒%d点怒气";
RAID = "团队";
...
REFORGED = "重铸";
REFORGE_CURRENT = "当前";
REFORGE_DESCRIPTION = "重铸使你能够改变物品等级在200级以上的武器或装备的属性。";
REFORGE_MISSING_ITEM = "将物品放在这里以进行重铸";
REFORGE_NEW_FILTER_TEXT = "增加一项属性";
REFORGE_NEW_STAT_LABLE = "选择增加的属性：";
REFORGE_OLD_FILTER_TEXT = "降低一项属性";
REFORGE_OLD_STAT_LABLE = "选择降低的属性：";
REFORGE_RESTORE = "恢复";
REFORGE_RESTORE_MESSAGE = "该物品已经被重铸过，在恢复原始属性前无法再次重铸。";
REFORGE_STAT_HELP = "选择属性，并使用上方的下拉框来查看重铸物品的结果。";
...
REVERSE_CLEAN_UP_BAGS_TEXT = "反向整理背包|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
REVERSE_NEW_LOOT_TEXT = "将战利品放入最左边的背包|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
REVERT = "反转";
REWARDS = "奖励";
...
ROGUE_ASS_CORE_ABILITY_1 = "从潜行状态发起战斗时使用。";
ROGUE_ASS_CORE_ABILITY_2 = "可用时使用。";
ROGUE_ASS_CORE_ABILITY_3 = "用于积累连击点数。";
ROGUE_ASS_CORE_ABILITY_4 = "当你有5个连击点数时，保持自己身上一直有此效果。";
ROGUE_ASS_CORE_ABILITY_5 = "当你有5个连击点数时，保持目标身上一直有此效果。";
ROGUE_ASS_CORE_ABILITY_6 = "当你有5个连击点数并且其他终结技的效果还未结束时使用。";
ROGUE_COMBAT_CORE_ABILITY_1 = "从潜行状态发起战斗时使用。";
ROGUE_COMBAT_CORE_ABILITY_2 = "保持目标身上一直有此效果。";
ROGUE_COMBAT_CORE_ABILITY_3 = "用于积累连击点数。";
ROGUE_COMBAT_CORE_ABILITY_4 = "当你有5个连击点数时，保持自己身上一直有此效果。";
ROGUE_COMBAT_CORE_ABILITY_5 = "当你有5个连击点数并且其他终结技的效果还未结束时使用。";
ROGUE_SUB_CORE_ABILITY_1 = "从潜行状态发起战斗时使用。";
ROGUE_SUB_CORE_ABILITY_2 = "保持目标身上一直有此效果，用于在从正面攻击目标时累积连击点数。";
ROGUE_SUB_CORE_ABILITY_3 = "当不从正面发起攻击时使用，用于积累连击点数。";
ROGUE_SUB_CORE_ABILITY_4 = "当你有5个连击点数时，保持自己身上一直有此效果。";
ROGUE_SUB_CORE_ABILITY_5 = "当你有5个连击点数时，保持目标身上一直有此效果。";
ROGUE_SUB_CORE_ABILITY_6 = "当你有5个连击点数并且其他终结技的效果还未结束时使用。";
ROLE = "职责";
...
RUNES = "符文";
RUNES_TOOLTIP = "被大部分死亡骑士用于攻击。每种符文每10秒充能一次。";
RUNE_COST_BLOOD = "%d鲜血";
RUNE_COST_CHROMATIC = "%d死亡";
RUNE_COST_FROST = "%d冰霜";
...
RUNIC_POWER_COST_PER_TIME_NO_BASE = "每秒%d点符文能量";
RURU = "俄语";
...
SHADOW_ORBS_COST_PER_TIME = "%d枚暗影宝珠，外加每秒%d枚";
SHADOW_ORBS_COST_PER_TIME_NO_BASE = "每秒%d个暗影宝珠";
SHADOW_ORBS_POWER = "暗影宝珠";
SHADOW_ORBS_TOOLTIP = "由心灵震爆和暗言术：灭产生。可用于施放噬灵疫病或强化心灵惊骇。";
SHADOW_QUALITY = "阴影质量";
SHAMAN_ELE_CORE_ABILITY_1 = "保持目标身上一直有此效果。";
SHAMAN_ELE_CORE_ABILITY_2 = "可用时使用。";
SHAMAN_ELE_CORE_ABILITY_3 = "当没有其它技能可用时使用。";
SHAMAN_ELE_CORE_ABILITY_4 = "当你有15层闪电之盾效果时使用。";
SHAMAN_ELE_CORE_ABILITY_5 = "随时保持激活状态。";
SHAMAN_ENHANCE_CORE_ABILITY_1 = "保持目标身上一直有此效果。";
SHAMAN_ENHANCE_CORE_ABILITY_2 = "可用时使用。";
SHAMAN_ENHANCE_CORE_ABILITY_3 = "可用时使用，用来扩散烈焰震击。";
SHAMAN_ENHANCE_CORE_ABILITY_4 = "当漩涡武器使其瞬发时使用。";
SHAMAN_ENHANCE_CORE_ABILITY_5 = "可用时使用，用来提高伤害。";
SHAMAN_ENHANCE_CORE_ABILITY_6 = "被动技能。使近战攻击降低自然法术的施法时间。";
SHAMAN_INTELLECT_TOOLTIP = "提高你的法力值上限和法术的爆击几率。\n使你更快地提升武器技能熟练度。";
SHAMAN_RESTO_CORE_ABILITY_1 = "保持主要治疗目标身上一直有此效果。";
SHAMAN_RESTO_CORE_ABILITY_2 = "缓慢但低消耗的治疗技能。";
SHAMAN_RESTO_CORE_ABILITY_3 = "一种快速但高消耗的治疗。";
SHAMAN_RESTO_CORE_ABILITY_4 = "可用时使用，尤其是在使用治疗链时。";
SHAMAN_RESTO_CORE_ABILITY_5 = "当小范围内的许多队员受伤时使用。";
SHAMAN_RESTO_CORE_ABILITY_6 = "当有多个距离较近的队员受伤时使用。";
...
SHOW_BATTLE_PET_TAMERS_ON_MAP_TEXT = "显示宠物训练师";
SHOW_BOSSES_ON_MAP_TEXT = "显示首领";
SHOW_BRACES = "显示括号";
...
SHOW_QUEST_OBJECTIVES_ON_MAP_TEXT = "显示目标";
...
SOUL_SHARDS = "灵魂碎片";
SOUL_SHARDS_COST = "%d灵魂碎片";
SOUL_SHARDS_COST_PER_TIME = "%d块灵魂碎片，外加每秒%d块";
SOUL_SHARDS_COST_PER_TIME_NO_BASE = "每秒%d个灵魂碎片";
SOUL_SHARDS_POWER = "灵魂碎片";
SOUL_SHARDS_TOOLTIP = "被灵魂燃烧用于强化特殊技能。";
...
SPEC_FRAME_HELP_3 = "点击\"学习\"按钮来确认你的选择。\n\n|cFFFF0000你可以随时访问你的职业训练师来重置你的选择。|r";
...
SPELL_BUCKET_YOU_WILL_EARN = "你已获得以下技能：";
SPELL_CASTING = "法术施放";
...
SPELL_FAILED_CUSTOM_ERROR_168 = "你不能在挑战模式下这么做。";
...
SPELL_FAILED_SHIPMENTS_FULL = "不能生产更多该类型的货物。";
...
START = "开始";
STARTING_PRICE = "起始价格";
STARTUP_STRINGSENUM_MSG_GX_FAIL_API_VERSION = "魔兽世界需要安装最新版本的DirectX Runtime才能运行。可通过Windows系统自动更新或直接从微软官网下载的方式，来获取最新版本的DirectX runtime。若要了解更多详情，请访问http://us.battle.net/support/en/article/driver-update-information。";
...
STAT_TEMPLATE = "%s状态";
STAT_TOOLTIP_BONUS_AP = "攻击强度提高%s";
STAT_TOOLTIP_BONUS_AP_SP = "攻击强度和法术强度提高%s";
STAT_TOOLTIP_SP_AP_DRUID = "法术强度提高%s，熊形态和猎豹形态下的敏捷提高%s。";
...
TALENT_FRAME_HELP_2 = "当你升到更高的等级，将解锁更多的天赋行。\n\n|cFFFF0000你可以随时访问你的职业训练师来重新分配你的天赋。|r";
TALENT_FRAME_HELP_3 = "点击\"学习\"按钮来确认你的选择。\n\n|cFFFF0000你可以随时访问你的职业训练师来重置你的选择。|r";
TALENT_MASTERY_LABEL = "精通：%s";
TALENT_MASTERY_TOOLTIP_NOT_KNOWN = "你必须在训练师处学习精通。";
TALENT_MICRO_BUTTON_NO_SPEC = "你还未选择职业专精。";
TALENT_MICRO_BUTTON_SPEC_TUTORIAL = "你现在可以选择一个职业专精了。点此以选择你的专精。";
...
TALENT_TOOLTIP_REMOVEPREVIEWPOINT = "右键点击以移除此天赋。";
...
TALENT_TREE_PREVIEW_TUTORIAL = "当你选择好天赋之后，请点击学习按钮以确认。你可以随时造访你的职业训练师以重置你所选择的天赋。";
TALL = "长";
TAMEABLE = "可驯服";
...
TEXT_MODE_A_STRING_REMAINING_POINTS = "（剩余%d）";
...
TOURNAMENT_RULES_TOOLTIP = "勾选同意之后，参与者将只能使用竞技装备。其他装备将无法使用。";
TOWNSFOLK_TRACKING_TEXT = "镇民";
TOWN_HALL = "";
TOY = "玩具";
TOYBOX_FAVORITE_HELP = "右键点击设置为偏好玩具。偏好玩具将始终出现在首页。";
TOYBOX_MICRO_BUTTON_SPEC_TUTORIAL = "打开玩具盒浏览你收藏的玩具。";
TOYBOX_MOUSEWHEEL_PAGING_HELP = "小提示：你可以使用鼠标滚轮快速翻看玩具盒的页面。";
TOY_BOX = "玩具箱";
...
TRACK_QUEST_SORTING = "新近追踪的任务排序|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
TRADESKILL_FILTER_SUBCLASS = "子分类";
...
TRANSMOGRIFY = "幻化";
TRANSMOGRIFY_BIND_CONFIRMATION_BOTH = "利用这些物品进行幻化将使其与你绑定，并且无法退还。";
TRANSMOGRIFY_BIND_CONFIRMATION_DESTINATION = "幻化后，该物品将\n无法退还。";
TRANSMOGRIFY_BIND_CONFIRMATION_SOURCE = "利用此物品进行幻化将使其与你绑定，并且无法退还、无法交易。";
TRANSMOGRIFY_INVALID_REASON1 = "该部位没有已装备物品。";
TRANSMOGRIFY_INVALID_REASON2 = "该物品不是灵魂绑定物品。";
TRANSMOGRIFY_INVALID_REASON3 = "传说物品不可幻化。";
TRANSMOGRIFY_INVALID_REASON4 = "该物品无法幻化。";
TRANSMOGRIFY_INVALID_REASON5 = "该物品无法幻化。";
TRANSMOGRIFY_TOOLTIP_APPLY = "幻化为：\n%s";
TRANSMOGRIFY_TOOLTIP_REVERT = "还原";
TRAVEL_PASS_INVITE = "邀请加入队伍";
TRIAL_ACCOUNT_LEVEL_CAP_REACHED = "你已经达到了试玩账号的最高角色等级。\124cffffd000\124HurlIndex:2\124h[点击此处]\124h\124r升级你的账号！";
TRIAL_ACCOUNT_MONEY_CAP_REACHED = "你已经获得了试玩账号允许携带的最大金额。\124cffffd000\124HurlIndex:2\124h[点击此处]\124h\124r升级你的账号！";
TRIAL_CAPPED = "已达试玩上限。";
TRIAL_CAPPED_MONEY = "已达试玩账号金币上限。";
TRIAL_LEVEL_CAPPED = "已达试玩等级上限。";
...
TURN_IN_ITEMS = "需要物品：";
TURN_IN_QUEST = "交还";
TUTORIAL1 = "任务NPC头顶上都会有一个感叹号(\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t)。|cffffd200右键点击|r他们可以获得一个任务。";
...
TUTORIAL1_DWARF = "任务NPC头顶上都会有一个感叹号(\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t)。你可以与|cffffd200乔恩·铁枷|r交谈来获得任务。|cffffd200右键点击|r|cffffd200乔恩·铁枷|r便可与其交谈。";
TUTORIAL1_GNOME = "任务NPC头顶上都会有一个感叹号(\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t)。你可以与|cffffd200内温·扭钳|r交谈来获得任务。|cffffd200右键点击|r|cffffd200内温·扭钳|r便可与其交谈。";
TUTORIAL1_HUMAN = "任务NPC头顶上都会有一个感叹号(\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t)。你可以与|cffffd200治安官玛克布莱德|r交谈来获得任务。|cffffd200右键点击|r|cffffd200治安官玛克布莱德|r便可与其交谈。";
TUTORIAL1_NIGHTELF = "任务NPC头顶上都会有一个感叹号(\124TInterface\\OptionsFrame \\UI-OptionsFrame-NewFeatureIcon:0\124t)。你可以与|cffffd200伊尔萨莱恩|r交谈来获得任务。|n|n|cffffd200右键点击|r他便可与其交谈。";
TUTORIAL1_ORC = "任务NPC头顶上都会有一个感叹号(\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t)。你可以与|cffffd200卡尔图克|r交谈来获得任务。|cffffd200右键点击|r|cffffd200卡尔图克|r便可与其交谈。";
TUTORIAL1_SCOURGE = "任务NPC头顶上都会有一个感叹号(\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t)。你可以与|cffffd200阿加萨|r交谈来获得任务。|cffffd200右键点击|r|cffffd200阿加萨|r便可与其交谈。";
TUTORIAL1_TAUREN = "任务NPC头顶上都会有一个感叹号(\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t)。你可以与|cffffd200鹰风酋长|r交谈来获得任务。|cffffd200右键点击|r|cffffd200鹰风酋长|r便可与其交谈。";
TUTORIAL1_TROLL = "任务NPC头顶上都会有一个感叹号(\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t)。你可以与|cffffd200金萨拉|r交谈来获得任务。|cffffd200右键点击|r|cffffd200金萨拉|r便可与其交谈。";
...
TUTORIAL55 = "恭喜！你已经击败了足够多的敌人，可以完成任务了|n|n去找任务给予人领取你的奖励吧。";
...
TUTORIAL61_ROGUE = "你通过影袭获得了|cffffd200连击点数|r，现在你可以使用更强大的|cffffd200终结技|r了，譬如刺骨。";
...
UNIT_NAME_HIDE_MINUS = "隐藏次要NPC名称|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
UNKNOWNOBJECT = "未知目标";
UNLEARN = "忘却这个技能";
UNLEARN_AT_YOUR_TRAINER = "你可以随时到训练师处进行遗忘。";
...
WARLOCK_AFFLICTION_CORE_ABILITY_1 = "保持目标身上一直有此效果。";
WARLOCK_AFFLICTION_CORE_ABILITY_2 = "保持目标身上一直有此效果。";
WARLOCK_AFFLICTION_CORE_ABILITY_3 = "保持目标身上一直有此效果。";
WARLOCK_AFFLICTION_CORE_ABILITY_4 = "当目标身上有你的持续伤害效果时使用。";
WARLOCK_AFFLICTION_CORE_ABILITY_5 = "当没有其它技能可用时使用。";
WARLOCK_AFFLICTION_CORE_ABILITY_6 = "用于强化多个技能。";
WARLOCK_DEMO_CORE_ABILITY_1 = "保持目标身上一直有此效果。";
WARLOCK_DEMO_CORE_ABILITY_2 = "当没有其它技能可用时使用。";
WARLOCK_DEMO_CORE_ABILITY_3 = "当触发熔火之心时使用。";
WARLOCK_DEMO_CORE_ABILITY_4 = "保持目标身上一直有此效果，尤其当有多个目标时。";
WARLOCK_DEMO_CORE_ABILITY_5 = "当你的恶魔之怒全满时使用，变形成恶魔。";
WARLOCK_DEMO_CORE_ABILITY_6 = "被动技能。使你的灵魂之火有时能快速施放。";
WARLOCK_DESTRO_CORE_ABILITY_1 = "保持目标身上一直有此效果。";
WARLOCK_DESTRO_CORE_ABILITY_2 = "可用时使用，用来产生爆燃灰烬。";
WARLOCK_DESTRO_CORE_ABILITY_3 = "当需要消耗爆燃灰烬时使用。";
WARLOCK_DESTRO_CORE_ABILITY_4 = "当没有其它技能可用时使用。";
WARLOCK_DESTRO_CORE_ABILITY_5 = "当目标濒临死亡且你有爆燃灰烬时使用。";
WARLOCK_INTELLECT_TOOLTIP = "提高你的法力值上限和法术的爆击几率。\n使你更快地提升武器技能熟练度。";
WARRIOR_ARMS_CORE_ABILITY_1 = "用其来发起战斗，可以在战斗开始时获得最多的起始怒气值。";
WARRIOR_ARMS_CORE_ABILITY_2 = "可用时使用，让目标承受更多伤害。";
WARRIOR_ARMS_CORE_ABILITY_3 = "可用时使用。最强的打击技能。";
WARRIOR_ARMS_CORE_ABILITY_4 = "保持目标身上一直有此效果。";
WARRIOR_ARMS_CORE_ABILITY_5 = "当你需要消耗怒气且没有其他技能可用时使用。";
WARRIOR_ARMS_CORE_ABILITY_6 = "当目标濒临死亡时使用。";
WARRIOR_FURY_CORE_ABILITY_1 = "用其来发起战斗，可以在战斗开始时获得最多的起始怒气值。";
WARRIOR_FURY_CORE_ABILITY_2 = "可用时使用。是主要的怒气生成手段。";
WARRIOR_FURY_CORE_ABILITY_3 = "可用时使用。";
WARRIOR_FURY_CORE_ABILITY_4 = "当可以免费使用或者需要泻怒时使用。";
WARRIOR_FURY_CORE_ABILITY_5 = "当目标濒临死亡时使用。";
WARRIOR_PROT_CORE_ABILITY_1 = "用其来发起战斗，可以在战斗开始时获得最多的起始怒气值。";
WARRIOR_PROT_CORE_ABILITY_2 = "可用时使用。是主要的怒气生成手段。";
WARRIOR_PROT_CORE_ABILITY_3 = "当没有其它技能可用时使用。";
WARRIOR_PROT_CORE_ABILITY_4 = "可用时使用。";
WARRIOR_PROT_CORE_ABILITY_5 = "使用怒气吸收伤害。";
WARRIOR_PROT_CORE_ABILITY_6 = "当你有60点怒气时使用，用于防御。";
