...
ITexture* CD3D11ManualTextureServices::addTexture( const char* name, const dimension2du& size, IImage* img, bool mipmap )
{
...
void CD3D11ManualTextureServices::removeTexture( const char* name )
{
