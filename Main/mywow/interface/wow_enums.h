...
enum POSITION_SLOTS : int32_t
{ 
	ATT_LEFT_WRIST = 0, 
	ATT_MOUNT_POINT = 0,		// Mountpoint
	ATT_RIGHT_PALM,
	ATT_LEFT_PALM,
	ATT_RIGHT_ELBOW,
	ATT_LEFT_ELBOW,
...
{
	return type == IT_DAGGER || type == IT_2HANDED;
}
...
enum SpellVisuakKitFlag : int32_t
{
	SVK_HEAD = 0,
	SVK_CHEST,
	SVK_GROUND,
