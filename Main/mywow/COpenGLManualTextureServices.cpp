...
ITexture* COpenGLManualTextureServices::addTexture( const char* name, const dimension2du& size, IImage* img, bool mipmap )
{
...
void COpenGLManualTextureServices::removeTexture( const char* name )
{
