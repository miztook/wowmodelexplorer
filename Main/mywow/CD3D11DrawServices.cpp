...
void CD3D11DrawServices::addSphere(const vector3df& center, float radius, SColor color, u32 hori /*= 10*/, u32 vert /*= 6*/)
{
...
void CD3D11DrawServices::addSphere_Flat(const vector3df& center, float radius, SColor color, u32 hori /*= 10*/, u32 vert /*= 6*/)
{
	u32 polyCountX = min_(hori, 20u);
	u32 polyCountY = min_(vert, 10u);
...
void CD3D11DrawServices::add3DVertices(vector3df* verts, u32 numverts, u16* indices, u32 numindices, SColor color)
{
...
void CD3D11DrawServices::add3DVertices(vector3df* verts, u32 numverts, SColor color)
{
	if (numverts + CurrentVertex3DCount >= VertexLimit ||
...
void CD3D11DrawServices::add2DQuads(ITexture* texture, const SVertex_PCT* vertices, u32 numQuads, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
	if (!texture)
		return;
...
void CD3D11DrawServices::draw2DImage(ITexture* texture, vector2di destPos, const recti* sourceRect /*= NULL_PTR*/, SColor color /*= SColor()*/, E_RECT_UVCOORDS uvcoords /*= ERU_00_11*/, float scale /*= 1.0f*/, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
	draw2DImageBatch(texture, &destPos, sourceRect ? &sourceRect : NULL_PTR, 1, color, uvcoords, scale, blendParam);
}

void CD3D11DrawServices::draw2DImageBatch(ITexture* texture, const vector2di* positions, const recti* sourceRects[], u32 batchCount, SColor color /*= SColor()*/, E_RECT_UVCOORDS uvcoords /*= ERU_00_11*/, float scale /*= 1.0f*/, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
...
void CD3D11DrawServices::draw2DImageBatch(ITexture* texture, const vector2di* positions, const recti* sourceRects[], const SColor* colors, u32 batchCount, E_RECT_UVCOORDS uvcoords /*= ERU_00_11*/, float scale /*= 1.0f*/, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
	ASSERT(texture || sourceRects);
	if (!texture && !sourceRects)
		return;
...
void CD3D11DrawServices::draw2DImageRect(ITexture* texture, const recti* destRect, const recti* sourceRect /*= NULL_PTR*/, SColor color /*= SColor()*/, E_RECT_UVCOORDS uvcoords /*= ERU_00_11*/, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
	draw2DImageRectBatch(texture, &destRect, sourceRect? &sourceRect : NULL_PTR, 1, color, uvcoords, blendParam);
}

void CD3D11DrawServices::draw2DImageRectBatch(ITexture* texture, const recti* destRects[], const recti* sourceRects[], u32 batchCount, SColor color /*= SColor()*/, E_RECT_UVCOORDS uvcoords /*= ERU_00_11*/, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
	if (batchCount > MaxImageBatch)
		batchCount = MaxImageBatch;
...
void CD3D11DrawServices::draw2DImageRectBatch(ITexture* texture, const recti* destRects[], const recti* sourceRects[], const SColor* colors, u32 batchCount, E_RECT_UVCOORDS uvcoords /*= ERU_00_11*/, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
	if (batchCount > MaxImageBatch)
		batchCount = MaxImageBatch;
...
void CD3D11DrawServices::draw2DSquadBatch(ITexture* texture, const SVertex_PCT* verts, u32 numQuads, const S2DBlendParam& blendParam)
{
...
void CD3D11DrawServices::draw2DVertices(ITexture* texture, const SVertex_PCT* verts, u32 numVerts, const u16* indices, u32 numIndices, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
