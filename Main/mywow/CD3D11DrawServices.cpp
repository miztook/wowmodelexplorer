...
CD3D11DrawServices::CD3D11DrawServices()
{
	Driver = static_cast<CD3D11Driver*>(g_Engine->getDriver());
	HWBufferServices = static_cast<CD3D11HardwareBufferServices*>(g_Engine->getHardwareBufferServices());
...
void CD3D11DrawServices::add2DLine(const line2di& line, SColor color)
{
...
void CD3D11DrawServices::add2DRect(const recti& rect, SColor color)
{
	if (Line2DVertexCount >= Line2DVertexLimit -2)
		return;//flushAll2DLines();
...
void CD3D11DrawServices::flushAll2DLines()
{
...
void CD3D11DrawServices::add3DLine(const line3df& line, SColor color)
{
...
void CD3D11DrawServices::addAABB(const aabbox3df& box, SColor color)
{
...
void CD3D11DrawServices::add3DBox(const vector3df& vPos, const vector3df& vDir, const vector3df& vUp, const vector3df& vRight, const vector3df& vExts, SColor color, const matrix4* pMat)
{
...
void CD3D11DrawServices::addSphere(const vector3df& center, float radius, SColor color, uint32_t hori /*= 10*/, uint32_t vert /*= 6*/)
{
...
void CD3D11DrawServices::flushAll3DLines(ICamera* cam)
{
...
void CD3D11DrawServices::addAABB_Flat(const aabbox3df& box, SColor color)
{
	if (!box.isValid() || 
...
void CD3D11DrawServices::add3DBox_Flat(const vector3df& vPos, const vector3df& vDir, const vector3df& vUp, const vector3df& vRight, const vector3df& vExts, SColor color, const matrix4* pMat)
{
...
void CD3D11DrawServices::addSphere_Flat(const vector3df& center, float radius, SColor color, uint32_t hori /*= 10*/, uint32_t vert /*= 6*/)
{
	uint32_t polyCountX = min_(hori, 20u);
	uint32_t polyCountY = min_(vert, 10u);
...
void CD3D11DrawServices::add3DVertices(vector3df* verts, uint32_t numverts, uint16_t* indices, uint32_t numindices, SColor color)
{
...
void CD3D11DrawServices::add3DVertices(vector3df* verts, uint32_t numverts, SColor color)
{
	if (numverts + CurrentVertex3DCount >= VertexLimit ||
...
void CD3D11DrawServices::flushAll3DVertices(ICamera* cam)
{
...
void CD3D11DrawServices::add2DColor(const recti& rect, SColor color, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
...
void CD3D11DrawServices::add2DQuads(ITexture* texture, const SVertex_PCT* vertices, uint32_t numQuads, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
	if (!texture)
		return;
...
void CD3D11DrawServices::flushAll2DQuads()
{
...
void CD3D11DrawServices::draw2DColor(const recti& rect, SColor color, float scale /*= 1.0f*/, E_BLEND_FACTOR srcBlend/*=EBF_ONE*/, E_BLEND_FACTOR destBlend/*=EBF_ONE_MINUS_SRC_ALPHA*/)
{
...
void CD3D11DrawServices::draw2DImage(ITexture* texture, vector2di destPos, const recti* sourceRect /*= nullptr*/, SColor color /*= SColor()*/, E_RECT_UVCOORDS uvcoords /*= ERU_00_11*/, float scale /*= 1.0f*/, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
	draw2DImageBatch(texture, &destPos, sourceRect ? &sourceRect : nullptr, 1, color, uvcoords, scale, blendParam);
}

void CD3D11DrawServices::draw2DImageBatch(ITexture* texture, const vector2di* positions, const recti* sourceRects[], uint32_t batchCount, SColor color /*= SColor()*/, E_RECT_UVCOORDS uvcoords /*= ERU_00_11*/, float scale /*= 1.0f*/, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
...
void CD3D11DrawServices::draw2DImageBatch(ITexture* texture, const vector2di* positions, const recti* sourceRects[], const SColor* colors, uint32_t batchCount, E_RECT_UVCOORDS uvcoords /*= ERU_00_11*/, float scale /*= 1.0f*/, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
	ASSERT(texture || sourceRects);
	if (!texture && !sourceRects)
		return;
...
void CD3D11DrawServices::draw2DImageRect(ITexture* texture, const recti* destRect, const recti* sourceRect /*= nullptr*/, SColor color /*= SColor()*/, E_RECT_UVCOORDS uvcoords /*= ERU_00_11*/, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
	draw2DImageRectBatch(texture, &destRect, sourceRect? &sourceRect : nullptr, 1, color, uvcoords, blendParam);
}

void CD3D11DrawServices::draw2DImageRectBatch(ITexture* texture, const recti* destRects[], const recti* sourceRects[], uint32_t batchCount, SColor color /*= SColor()*/, E_RECT_UVCOORDS uvcoords /*= ERU_00_11*/, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
	if (batchCount > MaxImageBatch)
		batchCount = MaxImageBatch;
...
void CD3D11DrawServices::draw2DImageRectBatch(ITexture* texture, const recti* destRects[], const recti* sourceRects[], const SColor* colors, uint32_t batchCount, E_RECT_UVCOORDS uvcoords /*= ERU_00_11*/, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
	if (batchCount > MaxImageBatch)
		batchCount = MaxImageBatch;
...
void CD3D11DrawServices::draw2DSquadBatch(ITexture* texture, const SVertex_PCT* verts, uint32_t numQuads, const S2DBlendParam& blendParam)
{
...
void CD3D11DrawServices::draw2DVertices(ITexture* texture, const SVertex_PCT* verts, uint32_t numVerts, const uint16_t* indices, uint32_t numIndices, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
