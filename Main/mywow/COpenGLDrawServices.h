...
class IIndexBuffer;
class COpenGLDriver;
class COpenGLHardwareBufferServices;

class COpenGLDrawServices : public IDrawServices
{
private:
	DISALLOW_COPY_AND_ASSIGN(COpenGLDrawServices);
...
private:
	...
	COpenGLHardwareBufferServices*		HWBufferServices;
