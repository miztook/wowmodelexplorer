...
{
	u32 num = sizeof(g_d3d11vs40_vertexShaderEntries) / sizeof(SVertexShaderEntry);
	for (u32 i=0; i<num; ++i)
	{
...
void CD3D11_VS40::CDiffuseT1_setShaderConst( IVertexShader* vs, const SMaterial& material, u32 pass )
{
...
void CD3D11_VS40::DiffuseT1_setShaderConst( IVertexShader* vs, const SMaterial& material, u32 pass )
{
	CD3D11VertexShader* d3d11vs = static_cast<CD3D11VertexShader*>(vs);
	CD3D11Driver* driver = static_cast<CD3D11Driver*>(g_Engine->getDriver());
	CD3D11SceneStateServices* sceneStateServices = static_cast<CD3D11SceneStateServices*>(driver->getSceneStateServices());
...
void CD3D11_VS40::Default_W_setShaderConst( IVertexShader* vs, const SMaterial& material, u32 pass )
{
	CD3D11VertexShader* d3d11vs = static_cast<CD3D11VertexShader*>(vs);
	CD3D11Driver* driver = static_cast<CD3D11Driver*>(g_Engine->getDriver());
...
void CD3D11_VS40::Default_WCol_setShaderConst( IVertexShader* vs, const SMaterial& material, u32 pass )
{
	CD3D11VertexShader* d3d11vs = static_cast<CD3D11VertexShader*>(vs);
	CD3D11Driver* driver = static_cast<CD3D11Driver*>(g_Engine->getDriver());
...
void CD3D11_VS40::Default_WColTex_setShaderConst( IVertexShader* vs, const SMaterial& material, u32 pass )
{
	CD3D11VertexShader* d3d11vs = static_cast<CD3D11VertexShader*>(vs);
	CD3D11Driver* driver = static_cast<CD3D11Driver*>(g_Engine->getDriver());
...
void CD3D11_VS40::Default_WTex_setShaderConst( IVertexShader* vs, const SMaterial& material, u32 pass )
{
	CD3D11VertexShader* d3d11vs = static_cast<CD3D11VertexShader*>(vs);
	CD3D11Driver* driver = static_cast<CD3D11Driver*>(g_Engine->getDriver());
...
void CD3D11_VS40::Terrain_setShaderConst( IVertexShader* vs, const SMaterial& material, u32 pass )
{
	CD3D11VertexShader* d3d11vs = static_cast<CD3D11VertexShader*>(vs);
	CD3D11Driver* driver = static_cast<CD3D11Driver*>(g_Engine->getDriver());
	CD3D11SceneStateServices* sceneStateServices = static_cast<CD3D11SceneStateServices*>(driver->getSceneStateServices());
...
void CD3D11_VS40::MapObjDiffuse_setShaderConst( IVertexShader* vs, const SMaterial& material, u32 pass )
{
	CD3D11VertexShader* d3d11vs = static_cast<CD3D11VertexShader*>(vs);
	CD3D11Driver* driver = static_cast<CD3D11Driver*>(g_Engine->getDriver());
	CD3D11SceneStateServices* sceneStateServices = static_cast<CD3D11SceneStateServices*>(driver->getSceneStateServices());
...
void CD3D11_VS40::MapObjSpecular_setShaderConst( IVertexShader* vs, const SMaterial& material, u32 pass )
{
	CD3D11VertexShader* d3d11vs = static_cast<CD3D11VertexShader*>(vs);
	CD3D11Driver* driver = static_cast<CD3D11Driver*>(g_Engine->getDriver());
	CD3D11SceneStateServices* sceneStateServices = static_cast<CD3D11SceneStateServices*>(driver->getSceneStateServices());
...
void CD3D11_VS40::DiffuseEnv_setShaderConst( IVertexShader* vs, const SMaterial& material, u32 pass )
{
	CD3D11VertexShader* d3d11vs = static_cast<CD3D11VertexShader*>(vs);
	CD3D11Driver* driver = static_cast<CD3D11Driver*>(g_Engine->getDriver());
	CD3D11SceneStateServices* sceneStateServices = static_cast<CD3D11SceneStateServices*>(driver->getSceneStateServices());
