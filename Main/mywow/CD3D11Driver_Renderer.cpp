...
void CD3D11Driver::helper_render( CMeshRenderer* meshRenderer, const SRenderUnit*& currentUnit, ICamera* cam )
{
...
void CD3D11Driver::helper_render( CTerrainRenderer* terrainRenderer, const SRenderUnit*& currentUnit, ICamera* cam )
{
	CD3D11SceneStateServices* sceneService = D3D11SceneStateServices;
...
void CD3D11Driver::helper_render( CWmoRenderer* wmoRenderer, const SRenderUnit*& currentUnit, ICamera* cam )
{
	CD3D11SceneStateServices* sceneService = D3D11SceneStateServices;
...
void CD3D11Driver::helper_render( CAlphaTestMeshRenderer* meshRenderer, const SRenderUnit*& currentUnit, ICamera* cam )
{
	matrix4 view = cam->getViewMatrix();
	matrix4 projection = cam->getProjectionMatrix();
...
void CD3D11Driver::helper_render( CAlphaTestWmoRenderer* wmoRenderer, const SRenderUnit*& currentUnit, ICamera* cam )
{
	CD3D11SceneStateServices* sceneService = D3D11SceneStateServices;
...
void CD3D11Driver::helper_renderAllBatches( CParticleRenderer* particleRenderer, const SRenderUnit*& currentUnit, ICamera* cam )
{
	matrix4 view = cam->getViewMatrix();
	matrix4 projection = cam->getProjectionMatrix();
...
void CD3D11Driver::helper_renderAllBatches( CRibbonRenderer* ribbonRenderer, const SRenderUnit*& currentUnit, ICamera* cam )
{
	matrix4 view = cam->getViewMatrix();
	matrix4 projection = cam->getProjectionMatrix();
...
void CD3D11Driver::helper_renderAllBatches( CMeshDecalRenderer* meshDecalRenderer, const SRenderUnit*& currentUnit, ICamera* cam )
{
	matrix4 view = cam->getViewMatrix();
	matrix4 projection = cam->getProjectionMatrix();
...
void CD3D11Driver::helper_renderAllBatches( CTransluscentDecalRenderer* transDecalRenderer, const SRenderUnit*& currentUnit, ICamera* cam )
{
	matrix4 view = cam->getViewMatrix();
	matrix4 projection = cam->getProjectionMatrix();
...
void CD3D11Driver::helper_renderAllBatches( CAlphaTestDecalRenderer* meshDecalRenderer, const SRenderUnit*& currentUnit, ICamera* cam )
{
	matrix4 view = cam->getViewMatrix();
	matrix4 projection = cam->getProjectionMatrix();
