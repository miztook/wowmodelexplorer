...
void CD3D9DrawServices::add2DLine(const line2di& line, SColor color)
{
...
void CD3D9DrawServices::add3DLine( const line3df& line, SColor color )
{
...
void CD3D9DrawServices::addAABB( const aabbox3df& box, SColor color )
{
...
void CD3D9DrawServices::add3DBox(const vector3df& vPos, const vector3df& vDir, const vector3df& vUp, const vector3df& vRight, const vector3df& vExts, SColor color, const matrix4* pMat)
{
...
void CD3D9DrawServices::addAABB_Flat(const aabbox3df& box, SColor color)
{
	if (!box.isValid() || 
...
void CD3D9DrawServices::add3DBox_Flat(const vector3df& vPos, const vector3df& vDir, const vector3df& vUp, const vector3df& vRight, const vector3df& vExts, SColor color, const matrix4* pMat)
{
...
void CD3D9DrawServices::add2DColor(const recti& rect, SColor color, const S2DBlendParam& blendParam /*= S2DBlendParam::OpaqueSource()*/)
{
...
void CD3D9DrawServices::flushAll2DQuads()
{
...
void CD3D9DrawServices::draw2DColor(const recti& rect, SColor color, float scale /*= 1.0f*/, E_BLEND_FACTOR srcBlend/*=EBF_ONE*/, E_BLEND_FACTOR destBlend/*=EBF_ONE_MINUS_SRC_ALPHA*/)
{
