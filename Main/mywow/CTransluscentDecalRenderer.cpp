...
CTransluscentDecalRenderer::CTransluscentDecalRenderer(uint32_t quota)
	: Quota(quota)
{
...
CTransluscentDecalRenderer::~CTransluscentDecalRenderer()
{

}

void CTransluscentDecalRenderer::addRenderUnit( const SRenderUnit* unit )
{
...
void CTransluscentDecalRenderer::render(const SRenderUnit*& currentUnit,  ICamera* cam)
{
...
void CTransluscentDecalRenderer::begin_setupLightFog( ICamera* cam ) const
{
...
void CTransluscentDecalRenderer::end_setupLightFog() const
{

}

void CTransluscentDecalRenderer::renderAllBatches( const SRenderUnit*& currentUnit, ICamera* cam )
{
...
bool CTransluscentDecalRenderer::isInBatch( const SBatch& batch, const SRenderUnit* unit ) const
{
...
bool CTransluscentDecalRenderer::isBatchExceed( const SBatch& batch, uint32_t vcount ) const
{
	return batch.vbase + batch.vcount + vcount + vcount > MeshDecalServices->getMaxVertexCount();
}

void CTransluscentDecalRenderer::addNewBatch( const SRenderUnit* unit )
{
	SBatch batch;
