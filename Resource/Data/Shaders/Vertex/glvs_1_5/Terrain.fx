...
out mediump vec4 v_Specular;
out mediump vec2 v_Tex0;		// vertex texture coords
out mediump vec3 v_Tex1;		// z: fog alpha
...
mediump float CalcFogFactor( float d, mediump vec4 fogParams )
{
